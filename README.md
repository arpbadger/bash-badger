** Disclaimer: I know this is bare bones, this is very much a work in progress. Scripts run as is in main branch, gui interface in the feature branch are still iffy.
